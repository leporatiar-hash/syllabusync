    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Welcome to ClassMate</h1>
          <p className="mt-1 text-sm text-slate-500">Enter your .edu email to start</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          First time here?{' '}
          <Link href="/signup" className="font-medium text-[#5B8DEF] hover:underline">
            Create your profile
          </Link>
        </p>
      </div>
